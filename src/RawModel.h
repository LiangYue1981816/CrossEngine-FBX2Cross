...
{
    RAW_VERTEX_ATTRIBUTE_POSITION      = 0x00000001,
    RAW_VERTEX_ATTRIBUTE_NORMAL        = 0x00000002,
    RAW_VERTEX_ATTRIBUTE_BINORMAL      = 0x00000004,
    RAW_VERTEX_ATTRIBUTE_COLOR         = 0x00000008,
    RAW_VERTEX_ATTRIBUTE_UV0           = 0x00000010,
    RAW_VERTEX_ATTRIBUTE_UV1           = 0x00000020,
    RAW_VERTEX_ATTRIBUTE_JOINT_INDICES = 0x00000040,
    RAW_VERTEX_ATTRIBUTE_JOINT_WEIGHTS = 0x00000080,
